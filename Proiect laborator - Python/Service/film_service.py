...
class FilmService:
    def __init__(self, film_repository: Repository, film_validator: FilmValidator, undo_redo_service: UndoRedoService):
    ...
    def update_film(self, id_film: str, titlu_new: str, an_aparitie_new: int,
        ...
        :return:
        """
        film_before = self.film_repository.read(id_film)
        ...
        self.undo_redo_service.clear_redo()
        updated_operation = UpdateOperation(self.film_repository, film, film_before)
    ...
    def delete_film(self, id_film: str) -> None:
        ...
        self.undo_redo_service.clear_redo()
        delete_operation = DeleteOperation(self.film_repository, self.film_repository.read(id_film))
