...
def test_full_text_search():
    ...
    card_client_repository = RepositoryJson(filename_card)
    ...
    film_repository = RepositoryJson(filename_film)
    rezervare_repository = RepositoryJson(filename_rezervare)
    ...
    assert rezervare_service.search_card("ana") == card_client_service.get_all_card()
    lst_error = ["Not found!"]
