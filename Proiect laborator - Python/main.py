...
from Tests.test_full_text_search import test_full_text_search
from Tests.test_incrementare_puncte_card import test_incrementare_puncte_card_client
from Tests.test_ordonare_card_client import test_ordonare_card_client
from Tests.test_ordoare_film import test_ordonare_film
from Tests.test_repository import test_repository
from Tests.test_service import test_card_client_service_add
from Tests.test_stergere_in_cascada import test_stergere_in_cascada
from Tests.test_stergere_rezervare_interval import test_stergere_rezervare_interval_data
from Tests.test_undo_redo import test_undo_redo
from UserInterface.console import Console


def main():
    film_repository = RepositoryJson("filme.json")
    ...
    rezervare_repository = RepositoryJson("rezervare.json")
    ...
    console = Console(film_service, card_client_service, rezervare_service, undo_redo_service)
    console.run_console()
