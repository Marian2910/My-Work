...
function getHomePageTemplate() {
  ...
  <div class="search-container">
    <input type="text" id="filter-name" placeholder="Cauta un eveniment" class="search-input" />
...
function setupNavigationEvents() {
  ...
  navLinks.forEach((link) => {
    ...
    if (link.getAttribute('href') === '/') {
      link.classList.add('nav-home-btn');
    } else if (link.getAttribute('href') === '/orders') {
      link.classList.add('nav-order-btn');
    }
  });

  const logoLink = document.getElementById('logo');
  if (logoLink) {
    logoLink.classList.remove('nav-home-btn', 'nav-order-btn');
  }
}
